...
public class Picture extends SimplePicture 
{
  ...
  public void mirrorArms()
  {
    ...
    for (int row = 153; row < 196; row++)
    {
      // 293
      // 239
      for (int col = 107; col < 180; col++)
      {
        leftPixel = pixels[row][col];      
        rightPixel = pixels[row+64][mirrorPoint - col + mirrorPoint + 6];
    ...
    for (int row = 172; row < 196; row++)
    {
      ...
      for (int col = 238; col < 294; col++)
      {
        ...
        leftPixel = pixels[row+64][mirrorPoint - (col - mirrorPoint) -7];
        leftPixel.setColor(rightPixel.getColor());
      }
    }
  }
  ...
  public void createCollage2()
  {
    ...
    this.copy2(gull,234,320,238,344);
    this.mirrorVertical();
    this.write("collage.jpg");
  }
